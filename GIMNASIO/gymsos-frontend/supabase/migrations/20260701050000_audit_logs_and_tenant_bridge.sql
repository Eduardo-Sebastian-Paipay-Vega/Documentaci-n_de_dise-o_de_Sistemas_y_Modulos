-- 20260701050000_audit_logs_and_tenant_bridge.sql
-- Capa 4b · audit_logs + tenant_id en gimnasios + backfill
-- PROVENIENCIA (materializado Fase 4, sin pérdida de lógica): 015b_patch_audit_logs.sql
