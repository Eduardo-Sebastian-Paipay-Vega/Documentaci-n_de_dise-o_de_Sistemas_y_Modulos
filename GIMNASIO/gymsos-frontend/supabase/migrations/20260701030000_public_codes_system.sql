-- 20260701030000_public_codes_system.sql
-- Capa 3 · Sistema de códigos public (cat_code_types, codes, code_usages) + RPCs
-- PROVENIENCIA (materializado Fase 4, sin pérdida de lógica): 010_shared_codes_system.sql
